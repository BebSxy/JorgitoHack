...
import me.ijese.jorgitohack.features.modules.chat.ChatModifier;
...
public class MixinGuiNewChat
    ...
    private int drawStringWithShadow(FontRenderer fontRenderer, String text, float x, float y, int color) {
        if (text.contains("\u00a7+")) {
            ...
            JorgitoHack.textManager.drawRainbowString(text, x, y, Color.HSBtoRGB(HUD.getInstance().hue, 1.0f, 1.0f), 100.0f, true);
        } else {
