...
extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        JorgitoHack.textManager.drawStringWithShadow(this.setting.getName() + " " + (Object)ChatFormatting.RED + (this.setting.currentEnumName().equalsIgnoreCase("ABC") ? "ABC" : this.setting.currentEnumName()), this.x + 2.3f, this.y - 4.0f - (float)JorgitoHackGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
    }
