package me.ijese.jorgitohack.features.gui.font;
...
public class CustomFont
    ...
    public float drawString(String textIn, double xI, double yI, int color, boolean shadow) {
        String text = NickHider.getInstance().isOn() && NickHider.getInstance().changeOwn.getValue() != false ? textIn.replace(NickHider.getPlayerName(), NickHider.getInstance().ownName.getValue()) : textIn;
        double x = xI;
        double y = yI;
