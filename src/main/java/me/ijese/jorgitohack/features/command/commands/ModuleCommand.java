...
import me.ijese.jorgitohack.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : JorgitoHack.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : JorgitoHack.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = JorgitoHack.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = JorgitoHack.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
