...
class BetterPortals
    ...
    public Setting< Boolean > portalChat = this.register ( new Setting <> ( "Chat" , Boolean.TRUE , "Allows you to chat in portals." ) );
    public Setting < Boolean > godmode = this.register ( new Setting <> ( "Godmode" , Boolean.FALSE , "Portal Godmode." ) );
