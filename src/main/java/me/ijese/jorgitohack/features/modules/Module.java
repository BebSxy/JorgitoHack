package me.ijese.jorgitohack.features.modules;
...
public class Module
    ...
    public void enable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            TextComponentString text = new TextComponentString(JorgitoHack.commandManager.getClientMessage() + " " + ChatFormatting.BOLD + this.getDisplayName() + ChatFormatting.GREEN + " Enabled");
    ...
    public void disable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            TextComponentString text = new TextComponentString(JorgitoHack.commandManager.getClientMessage() + " " + ChatFormatting.BOLD +  this.getDisplayName() + ChatFormatting.RED + " Disabled");
            Module.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(text, 1);
        }
        this.onToggle();
        this.onDisable();
    ...
    public void setDisplayName(String name) {
        Module module = JorgitoHack.moduleManager.getModuleByDisplayName(name);
        Module originalModule = JorgitoHack.moduleManager.getModuleByName(name);
