package me.ijese.jorgitohack.features;
...
public class Feature
    ...
    public TextManager renderer = JorgitoHack.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof JorgitoHackGui) {
            JorgitoHackGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
